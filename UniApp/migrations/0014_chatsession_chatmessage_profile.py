...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('UniApp', '0013_rename_recipient_message_receiver_and_more'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('chat_session', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='user_messages', to='UniApp.chatsession')),
            ],
            options={
