...
genders = ["Male", "Female"]
fields = ["Engineering", "Medicine", "Business", "Computer Science", "Law", "Arts", "Sciences", "Agriculture", "Education", "Health Science", "Natural Science", "Social Science"]
...
# Create a CSV file and store the student data
...
# Save the categorical transformer and label encoder
